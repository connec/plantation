(function() {
  var build, build_all, colors, compilers, directories, print_results, ref, sources, spaces, util, watch, watch_all, watchr,
    slice = [].slice;
  ...
  print_results = function() {
    var compiler, compiler_results, error, errors, j, k, l, len, len1, len2, len3, len4, m, max_compiler, max_source, o, ref1, ref2, ref3, ref4, results, results1, source, target;
    compiler_results = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    console.log();
    max_compiler = 0;
    max_source = 0;
    for (j = 0, len = compiler_results.length; j < len; j++) {
      ref1 = compiler_results[j], compiler = ref1.compiler, results = ref1.results;
    ...
    for (l = 0, len2 = compiler_results.length; l < len2; l++) {
      ref2 = compiler_results[l], compiler = ref2.compiler, results = ref2.results;
      compiler = spaces(max_compiler - compiler.length) + compiler;
      for (m = 0, len3 = results.length; m < len3; m++) {
        ref3 = results[m], source = ref3.source, target = ref3.target, error = ref3.error;
    ...
    for (o = 0, len4 = errors.length; o < len4; o++) {
      ref4 = errors[o], source = ref4.source, error = ref4.error;
